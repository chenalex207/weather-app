...
const fetchCurrentWeather = (StationName) => {
  ...
  return fetch(
    `https://opendata.cwa.gov.tw/api/v1/rest/datastore/O-A0003-001?Authorization=CWB-CFDF1608-3C22-4F6A-84C0-588F111DD420&locationName=${StationName}`
  )
...
const useWeatherApi = (currentLocation) => {
  ...
  const { StationName, cityName } = currentLocation;
